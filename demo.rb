...
5.times do |number|
  ...
  monster = Monster.new toughness: toughness,
                        notice: notice,
                        damage: damage,
                        exp: toughness * mult,
                        gold: damage * mult
  ...
  puts "What do you wand to do? (a) for attack, (f) for flee attempt"
  puts "================================================================"
...
if hero.dead? 
  ...
  puts "You killed #{kills} monsters and flee from #{} of them"
end